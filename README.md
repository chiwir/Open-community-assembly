...
The dataset was generated by varying the variance of Gaussian kennel for intrinsic rate, variance of Gaussian kennel for interaction strength and the mean $\lambda$ for generating number of species to be introduced using a Poisson distribution.
